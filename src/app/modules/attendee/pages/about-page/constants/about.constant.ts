import { StoryEntry } from "../model/about.model";
...
export const ABOUT_OUR_STORY: StoryEntry[] = [
  {
    cover: 'images/our-story-2.jpg',
    year: '2019',
    title: 'The Beginning',
    text: 'Founded by a team of event professionals who saw the need for better virtual event solutions.',
  },
  {
    cover: 'images/our-story-1.jpg',
    year: '2021',
    title: 'Global Expansion',
    text: 'Reached 1 million users worldwide and launched advanced networking features.',
  },
  {
    cover: 'images/our-story-3.jpg',
    year: '2024',
    title: 'Innovation Leader',
    text: 'Became the leading platform for hybrid events with AI-powered matchmaking and immersive experiences.',
  },
] as const;
